 ...
 */    
OpenLayers.Layer.ArcGISCacheXiaoxie = OpenLayers.Class(OpenLayers.Layer.XYZ, {  
    ...
    */
    getURL: function (bounds) {
        ...
        //var res=this.getResolutionForZoom(this.map.getZoom()-2);
        // tile center
        ...
        //alert("("+center.lon+","+center.lat+")"+res +"----"+x+"--" + y +"--"+z);
    ...
    CLASS_NAME: 'OpenLayers.Layer.ArcGISCacheXiaoxie' 
}); 
